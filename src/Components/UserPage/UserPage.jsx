            ...
            <div className={clickedEdit ? 'Box' : 'BoxHide'}>
              <div className={clickedEdit ? 'editBox' : 'editBoxHide'}>
                ...
                <div className="editField">
                  <div className={isClickedEmail ? 'editTileResized' : 'editTile'}>
                    <div
                    ...
                    >
                      <div className={isClickedEmail ? 'text' : 'textSmall'}>E-mail</div>
                      <input
                  ...
                  <div className={isClickedPhone ? 'editTileResized' : 'editTile'}>
                    <div
                      className={clickedEdit ? 'valueEdit' : 'valueEditHide'}
                      onClick={event => {
                        if (canExit === true) {
                    ...
                    >
                      <div className={isClickedPhone ? 'text' : 'textSmall'}>Telefon</div>
                      <input
                  ...
                  <div className={isClickedLocation ? 'editTileLocation' : 'editTile'}>
                    <div
                      className={clickedEdit ? 'valueEdit' : 'valueEditHide'}
                      onClick={event => {
                        if (canExit === true) {
                    ...
                    >
                      <div className={isClickedLocation ? 'text' : 'textSmall'}>Lokalizacja</div>
                    </div>
                  </div>
                </div>
                <button
