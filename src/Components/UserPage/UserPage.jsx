                    ...
                    <div className={styles.rightContainer}>
                        <div className={clickedEdit ? styles.editBox : styles.editBoxHide}>
                            ...
                            <div className={styles.editField}>
                                <div
                                    className={
                                        isClickedEmail ? styles.editTileResized : styles.editTile
                                    }
                                >
                                    <div
                                        className={
                                            clickedEdit ? styles.valueEdit : styles.valueEditHide
                                        }
                                        onClick={event => {
                                            if (canExit === true) {
                                ...
                                <div
                                    className={
                                        isClickedPhone ? styles.editTileResized : styles.editTile
                                    }
                                >
                                    <div
                                        className={
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            className={
                                                isClickedLocation ? styles.text : styles.textSmall
                                            }
                                        >
                                            Lokalizacja
                                        </div>
