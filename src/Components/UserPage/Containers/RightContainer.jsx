    ...
    return (
        <div className={styles.rightContainer}>
            ...
            <div className={values.clickedAdvance ? styles.editBoxPassword : styles.editBoxHide}>
                ...
                <div className={styles.editField}>
                    <div className={isClickedPassword ? styles.editTileResizedPassword : styles.editTile}>
                        <div
                            className={values.clickedAdvance ? styles.valueEdit : styles.valueEditHide}
                            onClick={() => {
                                if (canExit === true) {
                        ...
                        >
                            ...
                            />
                            <button
                                className={isClickedPassword ? styles.saveBtnPassword : styles.saveBtnPasswordHide}
                    ...
                    <div className={isClickedDelete ? styles.editTileResizedDelete : styles.editTile}>
                        <div
                            className={values.clickedAdvance ? styles.valueEdit : styles.valueEditHide}
                            onClick={() => {
                                if (canExit === true) {
                        ...
                        >
                            ...
                            <button onMouseEnter={() => {
                                setCanExit(false);
                                    ...
                                    onClick={deleteUser}
                                    className={isClickedDelete ? styles.deleteButton : styles.deleteButtonHide}>Usuń konto
                            </button>
                        </div>
                    </div>
                </div>
            </div>
            <div className={values.clickedEdit || values.clickedAdvance ? styles.rightHide : styles.right}>
